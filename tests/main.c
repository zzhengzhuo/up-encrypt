...
int main()
{
    ...
    do
    {
        ...
        // {
        //     rust_free_vec_u8(dkim_msg[i], dkim_msg_len[i], dkim_msg_len[i]);
        // }
        // rust_free_vec_usize(dkim_msg_len, dkim_msg_num, dkim_msg_num);
        // rust_free_ptr_vec(dkim_msg, dkim_msg_num, dkim_msg_num);
        ...
        // {
        //     rust_free_vec_u8(dkim_sig[i], dkim_sig_len[i], dkim_sig_len[i]);
        // }
        // rust_free_vec_usize(dkim_sig_len, dkim_sig_num, dkim_sig_num);
        // rust_free_ptr_vec(dkim_sig, dkim_sig_num, dkim_sig_num);
