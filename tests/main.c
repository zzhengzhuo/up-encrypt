...
int main()
{
    ...
    int ret = rsa_with_sha256_verify(e, &n[0], 256, message, strlen(message), sig, 256);
    assert(ret == 0);

    sig[0] = 33;
    ret = rsa_with_sha256_verify(e, &n[0], 256, message, 10, sig, 256);
